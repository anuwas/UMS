...
/* @var $searchModel app\models\UmsUserRoleMapSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Ums User Role Maps';
						...
						<section class="panel">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<?= Html::a('Add Ums User Role Map <i class=\"fa fa-plus\"></i>', ['create'], ['class' => 'btn btn-success']) ?>
										</div>
                                        </div>
